...
import { UserDataForgotPassword } from "../type/user.type";
...
export default function ForgotPassword() {
  ...
  const { mutate } = useMutation({
    ...
    onSuccess: (response) => {
      ...
      if (success) {
        toast.success("Please go to your email account to reset your password!!!");
      }
    },
    onError: (error) => {
      if (
        ...
        >
          ...
          <Form.Item style={{ marginBottom: "0px" }}>
            ...
            <div>
              ...
              <button style={styles.text} onClick={handleLoginClick}>
                Back to login{" "}
              </button>
            </div>
          </Form.Item>
